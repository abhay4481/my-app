...
const CoinDetails = () => {
    ...
    if (error) return <Error message="Something went wrong while fetching coin..." />
            ...
            loading ? <Loader /> : (
                <>
                    ...
                    <VStack spacing={'4'} p='16' alignItems={'flex-start'}>
                        ...
                        <Box p={'4'} w='full'>
                            <Item title='Max Apply' value={coin.market_data.max_supply} />
                            <Item title='Circulating Apply' value={coin.market_data.circulating_supply} />
